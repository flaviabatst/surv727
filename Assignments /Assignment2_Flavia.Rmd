...
```{r}
anti_join(interest_city_w, acs_il2, by = "location")
#106 cities cannot be matched. 
```
...
#There seems to be a  positive but weak relationship between household income and the search popularity of "loans".
