...
merged_data$hh_income_level[which(merged_data$hh_income > 54379.19)] <- "Above hh income"
...
#There seems to have a weak positive relationship between household income and the search popularity of "loans".
